    ...
    <View className="flex-1 relative">
      <SafeAreaView className="flex-1">
        ...
        <View className="flex-row justify-between items-center mx-4">
          ...
          <View className="rounded-2xl" style={{ backgroundColor: 'rgba(255,255,255,0.7)' }}>
            <Image className="h-12 w-12 rounded-2xl" source={require('../assets/images/kvothe.jpg')} style={{ backgroundColor: 'rgba(255,255,255,0.7)' }} />
          </View>
        </View>
        {/* Punch Line */}
        ...
        <View className="mx-4 flex-row justify-between items-center space-x-3">
          <View className="flex-row flex-1 p-4 bg-white rounded-3xl">
          ...
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Text className={"text-black text-base tracking-widest" + textClass}>
                    {category}
                  </Text>
                  {
                    isActive ? (
